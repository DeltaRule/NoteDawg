/*! jQuery v3.6.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias,-effects,-effects/Tween,-effects/animatedSelector | (c) OpenJS Foundation and other contributors | jquery.org/license */ !(function(e, t) {
    "use strict";
    ...
    (E.extend = E.fn.extend =
        function() {
            var e,
                ...
                l = !1;
            for (
                "boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++), "object" == typeof a || b(a) || (a = {}), s === u && ((a = this), s--); s < u; s++
            )
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(e) {
                            ...
                            return Q.CHILD.test(e[0]) ?
                                ...
                                (e[3] ?
                                    (e[2] = e[4] || e[5] || "") :
                                    n && V.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
                                    e.slice(0, 3));
                        },
                    },
                    filter: {
                                ...
                                function(e, t, n) {
                                    ...
                                    if (c) {
                                        ...
                                        if (((u = [m ? c.firstChild : c.lastChild]), m && d)) {
                                            ...
                                            (d && (p = s = (r = (i = (o = (a = e)[A] || (a[A] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === N && r[1]), !1 === p)
                                        )
                                            while ((a = (++s && a && a[l]) || (p = s = 0) || u.pop()))
                                                if (
    ...
    function Te(e, t, n, r, i, o) {
        ...
        if (
            (null == r && null == i ? ((i = n), (r = n = void 0)) : null == i && ("string" == typeof n ? ((i = r), (r = void 0)) : ((i = r), (r = n), (n = void 0))), !1 === i)
        )
            i = we;
        else if (!i) return e;
        return (
    ...
    E.each({
        ...
        E.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = we),
                    this.each(function() {
    ...
    function Fe(e, t, n) {
        ...
        return (
            ...
            ((a = n.getPropertyValue(t) || n[t]),
                s && (a = a.replace(We, "$1")),
                "" !== a || ie(e) || (a = E.style(e, t)), !m.pixelBoxStyles() &&
                Pe.test(a) &&
                Be.test(t) &&
                ((r = u.width),
                    (i = u.minWidth),
